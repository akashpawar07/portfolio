      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0">
            <button onClick={() => scrollToSection('home')} className="font-bold text-xl">Portfolio</button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden pb-4 h-screen">
            <div className="flex flex-col space-y-2">
              <NavItem className="hover:bg-gray-200 dark:hover:bg-gray-700" onClick={() => scrollToSection('home')} mobile>Home</NavItem>
              <NavItem className="hover:bg-gray-200 dark:hover:bg-gray-700" onClick={() => scrollToSection('about')} mobile>About</NavItem>
              <NavItem className="hover:bg-gray-200 dark:hover:bg-gray-700" onClick={() => scrollToSection('skills')} mobile>Skills</NavItem>
              <NavItem className="hover:bg-gray-200 dark:hover:bg-gray-700" onClick={() => scrollToSection('projects')} mobile>Projects</NavItem>
              <NavItem className="hover:bg-gray-200 dark:hover:bg-gray-700" onClick={() => scrollToSection('contact')} mobile>Contact</NavItem>
              <button
                onClick={toggleDarkMode}
